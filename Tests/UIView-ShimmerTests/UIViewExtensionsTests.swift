...
final class UIViewExtensionsTests: XCTestCase {
    ...
    func testGetFrameForRightAlignedLabel() {
        // Given
        let aLabel = ACustomLabel(intrinsicContentSize: CGSize(width: 75, height: 25))
...
fileprivate final class ACustomLabel: UILabel {
    ...
    convenience init(intrinsicContentSize: CGSize) {
        self.init()
        self._intrinsicContentSize = intrinsicContentSize
    }
